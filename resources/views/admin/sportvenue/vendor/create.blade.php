...
<head>
  ...
  <title>{{trans('app.AddVendor')}} | Admin | KuyRek</title>
          ...
          <div class="col-md-12">
            <div class="box box-primary">
              <div class="box-header with-border">
                <h3 class="box-title">{{trans('app.AddVendor')}}</h3>
              </div>
              <!-- /.box-header -->
              <form action="/admin/sportvenue/vendor" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                <div class="box-body">
                  <div class="form-group">
                    <label for="inputName">{{trans('app.VendorName')}}</label>
                    <div>
                      <input type="text" class="form-control" id="name" name="name" value="{{old('name')}}" placeholder="{{trans('app.VendorName')}}" required>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div>
                      <input type="text" class="form-control" id="whatsapp" name="whatsapp" value="{{old('whatsapp')}}" placeholder="Whatsapp" required>
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="inputName">ID Line</label>
                    <div>
                      <input type="text" class="form-control" id="line" name="line" value="{{old('line')}}" placeholder="ID Line">
                    </div>
                  </div>
                </div>
                <!-- /.box-body -->
