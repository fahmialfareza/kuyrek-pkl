...
<head>
	...
	<title>{{trans('app.SecureGuarantee')}} | KuyRek</title>
</head>
		...
		<div class="content-center fixed-header-margin">
			...
			<div class="content-push">
				...
				<div class="breadcrumb-box">
					...
					<a>{{trans('app.User')}}</a>
					<a>{{trans('app.SecureGuarantee')}}</a>
				</div>

				<div class="row">
					@include('layout.front.sidebaruser')
					<div class="col-md-9">

						<div class="information-blocks">
							<div class="sidebar-navigation">
								<div class="information-blocks" style="padding:10px;">
									<h3 class="block-title main-heading">{{trans('app.SecureGuarantee')}}</h3>
									<div class="row">
